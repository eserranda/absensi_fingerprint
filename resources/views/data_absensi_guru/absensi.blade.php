...
@section('content')
    <div class="row align-items-center">
        ...
        <div class="col">
            ...
            <div class="my-2 fw-bold"> NUPTK : {{ $data->nuptk }} </div>
        ...
        <div class="col-auto d-none d-md-flex">
            <a href="/rekap-absensi-guru" class="btn btn-primary">
    ...
    <div class="row row-deck row-cards mt-3">
        ...
        <div class="col-sm-6 col-lg-6">
            <div class="card">
                <div class="card-body">
                    <div class="card-title">Boidata Guru</div>
                    <div class="row row-deck row-cards mt-3">
                        <div class="col-sm-6 col-lg-6">
                            <div class="mb-0">
                        ...
                        <div class="col-sm-6 col-lg-6">
                            <div class="mb-0">
                                ...
                                NUPTK : <strong>{{ $data->nuptk }}</strong>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-lg-6">
                            <div class="mb-0">
                                ...
                                Status : <strong>{{ $data->status_pegawai }}</strong>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-lg-6">
                            <div class="mb-0">
                                ...
                                Jenis PTK : <strong>{{ $data->jenis_ptk }}</strong>
                            </div>
                        </div>

                    </div>

                    <div class="col-sm-12 col-lg-12 mt-3 mx-1">
                        <div class="mb-0">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline me-2" width="24"
                                height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
                                fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                <path d="M3 7l6 -3l6 3l6 -3v13l-6 3l-6 -3l-6 3v-13" />
        ...
        <script>
            document.addEventListener('DOMContentLoaded', async function() {
                ...
                try {
                    ...
                    const response = await fetch('{{ route('rekap-absensi-guru.filter-bulan') }}', {
                        method: 'POST',
                        body: formData,
                        headers: {
                ...
                document.getElementById('select-users').addEventListener('change', async function() {
                    ...
                    try {
                        ...
                        const response = await fetch(
                            '{{ route('rekap-absensi-guru.filter-bulan') }}', {
                                method: 'POST',
                                body: formData,
                                headers: {
                                    'X-CSRF-TOKEN': csrfToken,
