                    ...
                    <div class="btn-actions col-12">
                        ...
                        <div class="col-3 mx-2">
                            <select class="form-select" id="filterKelas">
                                ...
                                @foreach (App\Models\Kelas::get() as $data)
        ...
        <script>
            $(document).ready(function() {
                const myDataTable = $('.datatable').DataTable({
                    ...
                    ajax: "/rekap-absensi-siswa/rekap-kehadiran",
                    columns: [{
                            data: 'DT_RowIndex',
                            name: '#',
                            searchable: false
                ...
                $('#search').on('click', function() {
                    ...
                    let url = '/rekap-absensi-siswa/rekap-kehadiran/?';
                ...
                $('#reload').on('click', function() {
                    ...
                    $('#filterKelas').val('');
                    myDataTable.ajax.url('/rekap-absensi-siswa/rekap-kehadiran').load();
                });
            });
        </script>
    @endpush
